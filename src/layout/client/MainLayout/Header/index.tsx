...
//             width: downSM ? '100%' : '33%',
//             borderRadius: '20px',
//             boxShadow: '0px 4px 12px rgba(0, 0, 0, 0.1)', // Box-shadow nhẹ nhàng
//             py: 0.5,
//             marginLeft: { xs: '10px' },
//             bgcolor: theme.palette.background.paper,
//             transition: 'box-shadow 0.3s ease', // Hiệu ứng mượt khi hover
//             '&:hover': {
//               boxShadow: '0px 6px 16px rgba(0, 0, 0, 0.15)', // Tăng shadow khi hover
//             },
//           }}
//         >
//           <SearchIcon sx={{ mx: 1 }} />
      ...
      >
        {!downSM && (
          <Link to="/" style={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Typography fontWeight="bold" display={'flex'} alignItems={'center'}>
              Lập trình Ftech <SkewLoader size={7} cssOverride={{ marginLeft: '5px' }} />
            </Typography>
          </Link>
        )}
        ...
        >
            ...
            render={(attrs) => (
              <Wrapper
                sx={{
                  ...
                  maxHeight: '70vh',
                  overflow: 'auto',
                  boxShadow: '0px 4px 12px rgba(0, 0, 0, 0.1)', // Shadow cho dropdown
                  borderRadius: '8px',
                }}
                {...attrs}
              >
          ...
          {isLoading ? (
            ...
            searchValue && (
              <IconButton onClick={clearSearchValue} size="small">
                <BiX style={{ color: theme.palette.text.secondary }} />
              </IconButton>
            )
          )}
        </Paper>
