...
const ArtPlayerComponent = forwardRef(({ finished, videoUrl, poster, onCompleted, onTimeUpdate }, ref) => {
    const seek = useSelector((state) => state.homeReducer.seek);
    const isFirstPlaying = useSelector((state) => state.homeReducer.isFirstPlayingVideo);
