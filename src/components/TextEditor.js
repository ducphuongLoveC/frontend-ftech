...
import { Editor } from '@tinymce/tinymce-react';
import { useEffect, useState } from 'react';
const TextEditor = ({ onChange, initialValue, preview = false, initialHeight, 
// mode = 'basic',
disabled = false, value, }) => {
    ...
    const editorConfig = {
      ...
      bullist numlist outdent indent | table link image media | preview fullscreen | codesample',
        toolbar_mode: 'sliding', // Đảm bảo định dạng kiểu
        content_style: `
      body {
    ...
    return (_jsxs("div", { children: [_jsx(Editor, { value: content, disabled: disabled, apiKey: import.meta.env.VITE_TINY_MCE_API_KEY, init: editorConfig, onEditorChange: (content) => {
                    handleSave(content);
                } }), preview && (_jsx(_Fragment, { children: _jsxs("div", { children: [_jsx("h5", { children: "Content Preview:" }), _jsx("div", { dangerouslySetInnerHTML: { __html: content } })] }) }))] }));
};
export default TextEditor;
