...
import { SET_IS_FIRST_PLAYING_VIDEO, SET_ISPLAYING } from '@/store/actions'
...
const ArtPlayerComponent = forwardRef(({ finished, videoUrl, poster, onCompleted, onTimeUpdate }: ArtPlayerComponentProps, ref) => {
