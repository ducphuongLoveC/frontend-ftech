...
const schema = z.object({
  ...
  email: z
    ...
    .max(255, "Email không được vượt quá 255 ký tự"), // Email
  ...
  password: z
    ...
    .max(255, "Mật khẩu không được vượt quá 255 ký tự"), // Password
});
  ...
  return (
    <>
      ...
      >
        ...
        {errors.isVerifyOtp && (
          <FormHelperText error>{errors.isVerifyOtp.message}</FormHelperText>
        )}
