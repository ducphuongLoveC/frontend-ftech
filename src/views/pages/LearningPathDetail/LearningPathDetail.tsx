    ...
    <div className={styles.container}>
      <div className={styles.routeDetail}>
        ...
        <p className={styles.routeDetailSubtitle}>
          Hầu hết các websites hoặc ứng dụng di động đều có 2 phần là Front-end và Back-end. Front-end là phần giao diện
          người dùng nhìn thấy và có thể tương tác, đó chính là các ứng dụng mobile hay những website bạn đã từng sử
          dụng. Nhiệm vụ của lập trình viên Front-end là xây dựng các giao diện đẹp, dễ sử dụng và tối ưu trải nghiệm
          người dùng.
        </p>
        <p className={styles.routeDetailPrice}>
          Tại Việt Nam, <span className={styles.routeDetailPr}>lương trung bình</span> cho lập trình viên front-end vào
          khoảng 16.000.000đ/tháng.
        </p>
        <p className={styles.routeDetailCourse}>
          Dưới đây là các khóa học DevsHunt đã tạo ra dành cho bất cứ ai theo đuổi sự nghiệp trở thành một lập trình
          viên Front-end.
        </p>
        ...
        <div className={styles.courseMain}>
          ...
          <p className={styles.routeDetailSubtitle}>
            Để học web Front-end chúng ta luôn bắt đầu với ngôn ngữ HTML và CSS. Đây là 2 ngôn ngữ có mặt trong mọi
            website trên internet. Trong khóa học này F8 sẽ chia sẻ từ những kiến thức cơ bản nhất. Sau khóa học này bạn
            sẽ tự làm được 2 giao diện websites là The Band và Shopee.
          </p>
          <div className={styles.course}>
            <div className={styles.courseImg}>
            ...
            <div className={styles.courseInfor}>
              ...
              <p className={styles.courseDesc}>
                Từ cơ bản tới chuyên sâu, thực hành 8 dự án, hàng trăm bài tập, trang hỏi đáp riêng, cấp chứng chỉ sau
                khóa học và mua một lần học mãi mãi.
              </p>
              <button className={styles.watch}>XEM KHÓA HỌC</button>
            </div>
          </div>
          <div className={styles.course}>
            ...
            <div className={styles.courseInfor}>
              ...
              <span className={styles.coursePrice}>Miễn phí</span>
              <p className={styles.courseDesc}>
                Trong khóa này chúng ta sẽ học về cách xây dựng giao diện web responsive với Grid System, tương tự
                Bootstrap 4.
              </p>
              <button className={styles.watch}>XEM KHÓA HỌC</button>
            </div>
        ...
        <div className={styles.courseMain}>
          ...
          <p className={styles.routeDetailSubtitle}>
            Với HTML, CSS bạn mới chỉ xây dựng được các websites tĩnh, chỉ bao gồm phần giao diện và gần như chưa có xử
            lý tương tác gì. Để thêm nhiều chức năng phong phú và tăng tính tương tác cho website bạn cần học
            Javascript.
          </p>
          <div className={styles.course}>
            <div className={styles.courseImg}>
          ...
          <div className={styles.course}>
            ...
            <div className={styles.courseInfor}>
              ...
              <span className={styles.coursePrice}>Miễn phí</span>
              <p className={styles.courseDesc}>
                Hiểu sâu hơn về cách Javascript hoạt động, tìm hiểu về IIFE, closure, reference types, this keyword,
                bind, call, apply, prototype, ...
              </p>
              <button className={styles.watch}>XEM KHÓA HỌC</button>
            </div>
          </div>
        ...
        <div className={styles.courseMain}>
          ...
          <p className={styles.routeDetailSubtitle}>
            Cách làm việc với hệ điều hành Ubuntu/Linux qua Windows Terminal &amp; WSL. Khi đi làm, nhiều trường hợp bạn
            cần nắm vững các dòng lệnh cơ bản của Ubuntu/Linux.
          </p>
          <div className={styles.course}>
            <div className={styles.courseImg}>
        ...
        <div className={styles.courseMain}>
          ...
          <p className={styles.routeDetailSubtitle}>
            Sau khi đã nắm vững về Javascript và có kiến thức tốt về lập trình web, đã đến lúc học về các Framework và
            Libraries, nơi giúp bạn tối ưu và tăng tốc quá trình xây dựng ứng dụng web.
          </p>
          <div className={styles.course}>
            <div className={styles.courseImg}>
            ...
            <div className={styles.courseInfor}>
              ...
              <span className={styles.coursePrice}>Miễn phí</span>
              <p className={styles.courseDesc}>
                Học Back-end với Node & ExpressJS framework, hiểu các khái niệm khi làm Back-end và xây dựng RESTful API
                cho trang web.
              </p>
              <button className={styles.watch}>XEM KHÓA HỌC</button>
            </div>
