...
const PostManagement: React.FC = () => {
  ...
  return (
    <div className="tw-max-w-7xl tw-mx-auto tw-p-6 tw-min-h-screen">
      ...
      >
        <p>
          Chức năng "Thêm bài viết" cho phép người dùng quản lý hệ thống danh mục và thêm mới bài viết vào cơ sở dữ
          liệu.
        </p>
        <Button variant="contained" color="primary" className="tw-bg-purple-500 tw-text-white tw-py-2 tw-px-4">
          Thêm bài viết
            ...
            <div className="tw-flex-grow">
              ...
              <div className="tw-flex tw-justify-between">
                ...
                <div className="tw-mt-4 tw-text-sm tw-flex tw-w-[30%] tw-flex-col tw-text-gray-600">
                  <p>
                    <span className="tw-font-bold tw-py-2">Lượt xem:</span> {post.views}
                  </p>
                  <p>
                    <span className="tw-font-bold tw-py-2">Danh mục:</span> {post.category}
                  </p>
                  <p>
                    <span className="tw-font-bold tw-py-2">Ngày tạo:</span> {post.date}
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="tw-fixed tw-inset-0 tw-bg-black tw-bg-opacity-50 tw-flex tw-justify-center tw-items-center">
          <div className="tw-bg-white tw-p-4 tw-rounded tw-shadow-lg">
            ...
            <div className="tw-flex tw-justify-end tw-mt-4">
              <Button onClick={handleClose} className="tw-text-gray-500 tw-mr-4">
                Hủy
              </Button>
              <Button
                variant="contained"
